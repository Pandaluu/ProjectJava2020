...
class TestMappingEntities {
	...
	@Test
	void testSaveData2() {
		Movie kingKong = new Movie("King Kong",2005,180,List.of("Action","Adventure","Drama"));
		Movie mule = new Movie("La Mule",2018,116,List.of("Crime","Drama","Thriller")); 
		var movies = List.of(kingKong,mule);
		movies.forEach(repoMovies::save);
	}
